...
#ifndef __ITFBOARDCENTTC2XXX__
  #define __ITFBOARDCENTTC2XXX__
   ...
   #include <ItfCoreBoardBasic.h>
    ...
    #define FIRST_OUTPUT_PIN  IDX_24                   //!< First output PIN
    #define FIRST_MULTI_PIN   IDX_25                   //!< First multiple PIN
    #define SYSPIN_MAX            11                   //!< System PIN
    ...
    // System PINs
    #define PIN_SYS_BAT        (IDX_MAX)       //!<  97 - for TTC2310
    #define PIN_SYS_K15        (IDX_MAX+1)     //!<  98 - for TTC2310
    #define PIN_SYS_WAKEUP     (IDX_MAX+2)     //!<  99 - for TTC2310
    #define PIN_SYS_EMG_IN_A   (IDX_MAX+3)     //!< 100 - for TTC2310
    #define PIN_SYS_EMG_IN_B   (IDX_MAX+4)     //!< 101 - for TTC2310
    #define PIN_SYS_EMG_OUT_A  (IDX_MAX+5)     //!< 102 - for TTC2310
    #define PIN_SYS_TEMP       (IDX_MAX+6)     //!< 103 - for TTC2310
    #define PIN_SYS_REF        (IDX_MAX+7)     //!< 104 - for TTC2310
    #define PIN_SYS_S0         (IDX_MAX+8)     //!< 105 - for TTC2310
    #define PIN_SYS_S1         (IDX_MAX+9)     //!< 106 - for TTC2310
    #define PIN_SYS_S2         (IDX_MAX+10)    //!< 107 - for TTC2310

    #define PIN_SYS_START      PIN_SYS_BAT     //!< for TTC2310
    #define PIN_SYS_END        PIN_SYS_S2      //!< for TTC2310
    #define PIN_HST_END        PIN_SYS_END     //!< for TTC2310
