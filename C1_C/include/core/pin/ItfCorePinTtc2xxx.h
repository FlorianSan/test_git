...
//**************************************************************************************************
...
#ifndef __ITFCOREPINTTC2XXX__
    #define __ITFCOREPINTTC2XXX__
    ...
    {// RANGE  0 - 32767
        ...
        ADC_SYS_EMG_IN_A_D = 60,                       //!< [ON/OFF]
        ADC_SYS_EMG_IN_B_D = 61,                       //!< [ON/OFF]
        ADC_SYS_EMG_OUT_A_D = 62,                      //!< [ON/OFF]
        ADC_SYS_TEMP = 63,                             //!< [K]      Temperature (°C = x - ADC_KELVIN_OFFSET)
        ADC_SYS_DC_MAX = 64,                           //!< [-]      Maximum duty cycle on PWM output
        ADC_SYS_REF_VOLTAGE = 65,                      //!< [mV]     Reference voltage
        ADC_SYS_SENSOR_0_V = 66,                       //!< [mV]     Sensor supply voltage - PIN 247
        ADC_SYS_SENSOR_1_V = 67,                       //!< [mV]     Sensor supply Voltage - PIN 234
        ADC_SYS_SENSOR_VAR_V = 68,                     //!< [mV]     Sensor supply Voltage - PIN 221
        ADC_SYS_WAKEUP = 69                            //!< [ON/OFF] WakeUp, for power down after a wake up)
    }EAdcTyp;
    ...
    typedef enum
    {
        ...
        DAC_SYS_WAKEUP = 7,                            //!< [ON/OFF] Wake Up, for power down after a wake up)
        DAC_SYS_EMG_OUT_A = 8,                         //!<
        DAC_SYS_SENSOR_0_D = 9,                        //!< [ON/OFF] Switch the sensor supply
        DAC_SYS_SENSOR_1_D = 10,                       //!< [ON/OFF] Switch the sensor supply
        DAC_SYS_SENSOR_VAR_V = 11                      //!< [VAL_SENSOR_VAR_x] Switch the sensor supply
    }EDacTyp;
